...
var len__4499__auto___32065 = arguments.length;
var i__4500__auto___32066 = (0);
while(true){
if((i__4500__auto___32066 < len__4499__auto___32065)){
args__4502__auto__.push((arguments[i__4500__auto___32066]));

var G__32067 = (i__4500__auto___32066 + (1));
i__4500__auto___32066 = G__32067;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq32062){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32063,G__32064,seq32062__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32068_SHARP_){
return !((cljs.core.meta.call(null,p1__32068_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__32069__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32073){var _e__31053__auto__ = e32073;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e32075){var _e__31053__auto__ = e32075;
return false;
}}
})())){
...
var _STAR_current_state_STAR_32077 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__32078 = opts;
...
var markup_db = cljs.core.get.call(null,map__32078__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_32077;
}});
...
;
var temp__5455__auto___32082 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___32082)){
var managed_print_level_32083 = temp__5455__auto___32082;
var _STAR_print_level_STAR_32081_32084 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_32083;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_32081_32084,managed_print_level_32083,temp__5455__auto___32082,writer,opts,job_fn){
return (function (p1__32080_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__32080_SHARP_,null);
});})(_STAR_print_level_STAR_32081_32084,managed_print_level_32083,temp__5455__auto___32082,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_32081_32084;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1557149767620
