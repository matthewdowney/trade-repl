...
var file = cljs.core.get.call(null,map__32752__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__32752__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__32752__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e32751){var _e = e32751;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___32754 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___32754)){
var seen_errors_32755 = temp__5455__auto___32754;
if(cljs.core.truth_(seen_errors_32755.has(self))){
} else {
seen_errors_32755.add(self);

var temp__5457__auto___32756 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___32756)){
var sense_32757 = temp__5457__auto___32756;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_32757)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1557149768676
