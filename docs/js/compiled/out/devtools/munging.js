...
var o31934 = temp__5455__auto__;
var temp__5455__auto____$1 = (o31934["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o31935 = temp__5455__auto____$1;
return (o31935["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__31046__auto__ = f;
return (o__31046__auto__["toString"]).call(o__31046__auto__);
} else {
return "";
}
}catch (e31936){var _ = e31936;
return "";
}});
...
try{var o__31046__auto___31938 = t;
(o__31046__auto___31938["cljs$lang$ctorPrWriter"]).call(o__31046__auto___31938,t,writer);
}catch (e31937){var __31939 = e31937;
}
...
var char_code = (function (){var o__31046__auto__ = (new String(char$));
return (o__31046__auto__["charCodeAt"]).call(o__31046__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__31046__auto__ = String;
return (o__31046__auto__["fromCharCode"]).call(o__31046__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__31940 = num_code;
switch (G__31940) {
case (1):
return (185);
...
var o__31046__auto__ = String;
return (o__31046__auto__["fromCharCode"]).call(o__31046__auto__,superscript_code);
});
/**
...
}catch (e31942){var _e__31053__auto__ = e31942;
return false;
}})())){
...
var vec__31943 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__31943,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o31946 = temp__5455__auto__;
var temp__5455__auto____$1 = (o31946["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o31947 = temp__5455__auto____$1;
return (o31947["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__31950){
var vec__31951 = p__31950;
var ns_detector = cljs.core.nth.call(null,vec__31951,(0),null);
...
var G__31957 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__31958 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__31957;
remaining_tokens = G__31958;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq31948){
...
var vec__31962 = cljs.core.split_with.call(null,(function (p1__31961_SHARP_){
return cljs.core.not_EQ_.call(null,p1__31961_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__31962,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__31962,(1),null);
...
var vec__31965 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__31965,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__31965,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__31968 = cljs.core.rest.call(null,remaining_tokens);
var G__31969 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__31968;
name_tokens = G__31969;
continue;
} else {
...
var vec__31972 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__31972,(0),null);
var arity = cljs.core.nth.call(null,vec__31972,(1),null);
var vec__31975 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__31975,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__31975,(1),null);
var vec__31978 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__31978,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__31978,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__31978,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__31978,(3),null);
...
var vec__31984 = result;
var munged_ns = cljs.core.nth.call(null,vec__31984,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__31984,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__31984,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__31984,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__31984,(4),null);
var arity = cljs.core.nth.call(null,vec__31984,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__31988 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__31988,(0),null);
var args = cljs.core.nth.call(null,vec__31988,(1),null);
var vec__31991 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__31991,(0),null);
var name = cljs.core.nth.call(null,vec__31991,(1),null);
...
var G__31994 = (arity + (1));
var G__31995 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__31996){
var vec__31997 = p__31996;
var arity = cljs.core.nth.call(null,vec__31997,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__31997,(1),null);
...
return cljs.core.get.call(null,arities,p1__32000_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__32001_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__32004){
var vec__32005 = p__32004;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__32005,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq32002){
...
var map__32013 = options;
var map__32013__$1 = ((((!((map__32013 == null)))?(((((map__32013.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32013.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__32013):map__32013);
var include_ns_QMARK_ = cljs.core.get.call(null,map__32013__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__32013__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__32013__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__32013__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__32014 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__32014,(0),null);
var fn_name = cljs.core.nth.call(null,vec__32014,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__32014,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__32014,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__32014,(4),null);
var arity = cljs.core.nth.call(null,vec__32014,(5),null);
...
var o__31046__auto__ = f;
return (o__31046__auto__["getBasis"]).call(o__31046__auto__);
});
/**
...
}catch (e32018){var _e__31053__auto__ = e32018;
...
var G__32019 = (obj[cljs.core.first.call(null,path)]);
var G__32020 = cljs.core.rest.call(null,path);
obj = G__32019;
path = G__32020;
continue;
} else {
...
return (function (accum,p__32021){
var vec__32022 = p__32021;
var bit = cljs.core.nth.call(null,vec__32022,(0),null);
var protocol = cljs.core.nth.call(null,vec__32022,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__32025){
var vec__32026 = p__32025;
var ns = cljs.core.nth.call(null,vec__32026,(0),null);
var name = cljs.core.nth.call(null,vec__32026,(1),null);
var selector = cljs.core.nth.call(null,vec__32026,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__32031,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__32031,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__32031,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__32029_SHARP_){
return (obj[cljs.core.first.call(null,p1__32029_SHARP_)]);
});})(name,sorted_matches,vec__32031,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1557149767417
