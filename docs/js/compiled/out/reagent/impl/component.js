...
if((i < len)){
var k = (ks[i]);
var G__26749 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__26750 = (i + (1));
m = G__26749;
i = G__26750;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__26752 = c;
var G__26752__$1 = (((G__26752 == null))?null:G__26752.prototype);
if((G__26752__$1 == null)){
return null;
} else {
return (G__26752__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__26754 = c;
var G__26754__$1 = (((G__26754 == null))?null:G__26754.prototype);
if((G__26754__$1 == null)){
return null;
} else {
return (G__26754__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__26757__delegate = function (args){
...
while (G__26758__i < G__26758__a.length) {G__26758__a[G__26758__i] = arguments[G__26758__i + 0]; ++G__26758__i;}
  args = new cljs.core.IndexedSeq(G__26758__a,0,null);
} 
return G__26757__delegate.call(this,args);};
G__26757.cljs$lang$maxFixedArity = 0;
G__26757.cljs$lang$applyTo = (function (arglist__26759){
var args = cljs.core.seq(arglist__26759);
return G__26757__delegate(args);
});
...
var _STAR_current_component_STAR_26761 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_26761;
}});
...
return ((function (G__26762,G__26762__$1){
...
var c = this;
var G__26767_26769 = (c["cljsRatom"]);
if((G__26767_26769 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__26767_26769);
}
...
var renders_26771 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_26772 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_26771));
if((cljs.core.count.call(null,renders_26771) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_26771))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_26772)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_26772))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__26770 = name;
switch (G__26770) {
case "":
...
var G__26774 = o;
(G__26774[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__26775 = fiber;
var G__26775__$1 = (((G__26775 == null))?null:(G__26775["type"]));
if((G__26775__$1 == null)){
return null;
} else {
return (G__26775__$1["displayName"]);
}
})();
var parent = (function (){var G__26776 = fiber;
if((G__26776 == null)){
return null;
} else {
return (G__26776["return"]);
}
})();
var path = (function (){var G__26777 = parent;
var G__26777__$1 = (((G__26777 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__26777));
if((G__26777__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26777__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__26779 = c;
if((G__26779 == null)){
return null;
} else {
return (G__26779["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__26780._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__26782 = c;
if((G__26782 == null)){
return null;
} else {
return (G__26782["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__26784 = c;
if((G__26784 == null)){
return null;
} else {
return G__26784._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__26786 = instance;
if((G__26786 == null)){
return null;
} else {
return (G__26786["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__26787 = instance;
if((G__26787 == null)){
return null;
} else {
return G__26787._currentElement;
}
}
})();
var name = (function (){var G__26788 = elem;
var G__26788__$1 = (((G__26788 == null))?null:(G__26788["type"]));
if((G__26788__$1 == null)){
return null;
} else {
return (G__26788__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__26790 = elem;
if((G__26790 == null)){
return null;
} else {
return (G__26790["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__26791._owner;
}
}
})();
var path = (function (){var G__26792 = owner;
var G__26792__$1 = (((G__26792 == null))?null:reagent.impl.component.component_path.call(null,G__26792));
if((G__26792__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26792__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__26793 = c;
var G__26793__$1 = (((G__26793 == null))?null:G__26793.constructor);
if((G__26793__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__26793__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1557149752803
