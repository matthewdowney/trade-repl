...
var G__26796 = o;
(G__26796[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__26798__i < G__26798__a.length) {G__26798__a[G__26798__i] = arguments[G__26798__i + 0]; ++G__26798__i;}
  args = new cljs.core.IndexedSeq(G__26798__a,0,null);
} 
...
var args = cljs.core.seq(arglist__26799);
...
var G__26800 = o;
(G__26800[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__26805 = props;
var G__26805__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__26805,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26805);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__26805__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26806){
...
var props = map__26807__$1;
var class$ = cljs.core.get.call(null,map__26807__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__26807,map__26807__$1,props,class$){
return (function (c){
...
});})(map__26807,map__26807__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26809){
...
var on_write = cljs.core.get.call(null,map__26810__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__26810,map__26810__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__26810,map__26810__$1,on_write))
);
} else {
...
var G__26813 = jsprops;
(G__26813["defaultValue"] = value);

(G__26813["onChange"] = ((function (G__26813,v,value,on_change){
return (function (p1__26812_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26812_SHARP_);
});})(G__26813,v,value,on_change))
);
...
var vec__26816 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26816,(0),null);
var id = cljs.core.nth.call(null,vec__26816,(1),null);
var class$ = cljs.core.nth.call(null,vec__26816,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___26820 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___26820 == null)){
} else {
var key_26821 = temp__5461__auto___26820;
(jsprops["key"] = key_26821);
}
...
var temp__5461__auto___26822 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___26822 == null)){
} else {
var key_26823 = temp__5461__auto___26822;
reagent.impl.template.oset.call(null,jsprops,"key",key_26823);
}
...
var G__26824 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__26824["name"] = c);
...
var len__4499__auto___26829 = arguments.length;
var i__4500__auto___26830 = (0);
while(true){
if((i__4500__auto___26830 < len__4499__auto___26829)){
args__4502__auto__.push((arguments[i__4500__auto___26830]));

var G__26831 = (i__4500__auto___26830 + (1));
i__4500__auto___26830 = G__26831;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26827){
var G__26828 = cljs.core.first.call(null,seq26827);
var seq26827__$1 = cljs.core.next.call(null,seq26827);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26828,seq26827__$1);
});
...
break;
default:
var G__26834 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__26834;
continue;
...
var n__4376__auto___26836 = a.length;
var i_26837 = (0);
while(true){
if((i_26837 < n__4376__auto___26836)){
(a[i_26837] = reagent.impl.template.as_element.call(null,(a[i_26837])));
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___26839 = a.length;
var i_26840 = (0);
while(true){
if((i_26840 < n__4376__auto___26839)){
var val_26841 = (a[i_26840]);
if(((cljs.core.vector_QMARK_.call(null,val_26841)) && ((reagent.impl.template.key_from_vec.call(null,val_26841) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26840] = reagent.impl.template.as_element.call(null,val_26841));

var G__26842 = (i_26840 + (1));
i_26840 = G__26842;
continue;
} else {
}
...
var ctx = ({});
var vec__26843 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__26843,(0),null);
var derefed = cljs.core.nth.call(null,vec__26843,(1),null);
...
var G__26846 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26846) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__26846){
...
//# sourceMappingURL=template.js.map?rel=1557149752953
