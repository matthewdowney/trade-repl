...
var G__26055 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26055;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26056 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26056,ch);
...
if(("\\" === ch__$1)){
var ch_26057__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26057__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26057__$2);
} else {
}
...
var vec__26066 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26066,(0),null);
var start_column = cljs.core.nth.call(null,vec__26066,(1),null);
...
var G__26069 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26069;
continue;
}
}
...
var _STAR_read_delim_STAR_26070 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_26070;
}});
/**
...
var vec__26074 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26074,(0),null);
var end_column = cljs.core.nth.call(null,vec__26074,(1),null);
...
var vec__26077 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26077,(0),null);
var start_column = cljs.core.nth.call(null,vec__26077,(1),null);
...
var vec__26080 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26080,(0),null);
var end_column = cljs.core.nth.call(null,vec__26080,(1),null);
...
var vec__26083 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26083,(0),null);
var start_column = cljs.core.nth.call(null,vec__26083,(1),null);
...
var vec__26086 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26086,(0),null);
var end_column = cljs.core.nth.call(null,vec__26086,(1),null);
...
var sb = (function (){var G__26089 = (new goog.string.StringBuffer());
G__26089.append(initch);
...
var G__26091 = (function (){var G__26090 = sb;
G__26090.append(ch);

return G__26090;
})();
var G__26092 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26091;
ch = G__26092;
continue;
}
...
switch (G__26095) {
case "\\":
var G__26099 = (function (){var G__26096 = sb;
G__26096.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26096;
})();
var G__26100 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26099;
ch = G__26100;
continue;
...
break;
default:
var G__26101 = (function (){var G__26097 = sb;
G__26097.append(ch);

return G__26097;
})();
var G__26102 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26101;
ch = G__26102;
continue;
...
var vec__26103 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26103,(0),null);
var end_column = cljs.core.nth.call(null,vec__26103,(1),null);
...
var vec__26106 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26106,(0),null);
var column = cljs.core.nth.call(null,vec__26106,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__26121,(0),null);
var start_column = cljs.core.nth.call(null,vec__26121,(1),null);
...
var vec__26124 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26124,(0),null);
var end_column = cljs.core.nth.call(null,vec__26124,(1),null);
...
var G__26127 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26127,true,null,opts,pending_forms);
...
var G__26128 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26128)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26128)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26128)){
...
var _STAR_suppress_read_STAR_26129 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26129;
}});
...
var G__26130 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26130,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26130,rdr,first_line);
...
var G__26134 = matched;
var G__26135 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26134;
finished = G__26135;
continue;
} else {
...
var _STAR_suppress_read_STAR_26136 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26136;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env26137 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26138 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26138,"(");
...
var G__26139 = (i + (1));
var G__26140 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env26137;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26141 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26141);
...
var G__26142 = cljs.core.next.call(null,s__$1);
var G__26143 = ret;
s__$1 = G__26142;
r = G__26143;
continue;
...
var G__26144 = cljs.core.next.call(null,s);
var G__26145 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26144;
key_vals = G__26145;
continue;
} else {
...
var gensym_env26149 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env26149;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26150 = token;
var G__26150__$1 = (((G__26150 == null))?null:cljs.core.subs.call(null,G__26150,(1)));
var G__26150__$2 = (((G__26150__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26150__$1));
var G__26150__$3 = (((G__26150__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26150__$2));
var G__26150__$4 = (((G__26150__$3 == null))?null:cljs.core.symbol.call(null,G__26150__$3));
if((G__26150__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26150__$4);
}
})():(function (){var G__26151 = token;
var G__26151__$1 = (((G__26151 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26151));
if((G__26151__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26151__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26162,reader){
...
var eof = cljs.core.get.call(null,map__26163__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___26171 = arguments.length;
var i__4500__auto___26172 = (0);
while(true){
if((i__4500__auto___26172 < len__4499__auto___26171)){
args__4502__auto__.push((arguments[i__4500__auto___26172]));

var G__26173 = (i__4500__auto___26172 + (1));
i__4500__auto___26172 = G__26173;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq26169){
var G__26170 = cljs.core.first.call(null,seq26169);
var seq26169__$1 = cljs.core.next.call(null,seq26169);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26170,seq26169__$1);
});
