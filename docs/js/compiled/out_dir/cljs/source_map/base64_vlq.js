...
var digit_15951 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_15952__$1 = (vlq >>> (5));
while(true){
if((vlq_15952__$1 > (0))){
var digit_15953__$1 = (digit_15951 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_15953__$1));

var G__15954 = (vlq_15952__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__15955 = (vlq_15952__$1 >>> (5));
digit_15951 = G__15954;
vlq_15952__$1 = G__15955;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_15951));
}
break;
}
...
var G__15956 = i__$1;
var G__15957 = result__$1;
var G__15958 = shift__$1;
i = G__15956;
result = G__15957;
shift = G__15958;
continue;
