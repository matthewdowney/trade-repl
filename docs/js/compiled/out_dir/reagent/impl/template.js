...
var G__18070 = o;
(G__18070[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__18074 = o;
(G__18074[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__18079 = props;
var G__18079__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__18079,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__18079);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__18079__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__18080){
...
var props = map__18081__$1;
var class$ = cljs.core.get.call(null,map__18081__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__18081,map__18081__$1,props,class$){
return (function (c){
...
});})(map__18081,map__18081__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__18083){
var map__18084 = p__18083;
var map__18084__$1 = ((((!((map__18084 == null)))?(((((map__18084.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18084.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18084):map__18084);
var on_write = cljs.core.get.call(null,map__18084__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__18084,map__18084__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__18084,map__18084__$1,on_write))
);
} else {
...
var G__18087 = jsprops;
(G__18087["defaultValue"] = value);

(G__18087["onChange"] = ((function (G__18087,v,value,on_change){
return (function (p1__18086_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__18086_SHARP_);
});})(G__18087,v,value,on_change))
);
...
var vec__18090 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__18090,(0),null);
var id = cljs.core.nth.call(null,vec__18090,(1),null);
var class$ = cljs.core.nth.call(null,vec__18090,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___18094 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___18094 == null)){
} else {
var key_18095 = temp__5461__auto___18094;
(jsprops["key"] = key_18095);
}
...
var temp__5461__auto___18096 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___18096 == null)){
} else {
var key_18097 = temp__5461__auto___18096;
reagent.impl.template.oset.call(null,jsprops,"key",key_18097);
}
...
var G__18098 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__18098["name"] = c);
...
var len__4499__auto___18103 = arguments.length;
var i__4500__auto___18104 = (0);
while(true){
if((i__4500__auto___18104 < len__4499__auto___18103)){
args__4502__auto__.push((arguments[i__4500__auto___18104]));

var G__18105 = (i__4500__auto___18104 + (1));
i__4500__auto___18104 = G__18105;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq18101){
var G__18102 = cljs.core.first.call(null,seq18101);
var seq18101__$1 = cljs.core.next.call(null,seq18101);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18102,seq18101__$1);
});
...
break;
default:
var G__18108 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__18108;
continue;
...
var n__4376__auto___18110 = a.length;
var i_18111 = (0);
while(true){
if((i_18111 < n__4376__auto___18110)){
(a[i_18111] = reagent.impl.template.as_element.call(null,(a[i_18111])));
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___18113 = a.length;
var i_18114 = (0);
while(true){
if((i_18114 < n__4376__auto___18113)){
var val_18115 = (a[i_18114]);
if(((cljs.core.vector_QMARK_.call(null,val_18115)) && ((reagent.impl.template.key_from_vec.call(null,val_18115) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_18114] = reagent.impl.template.as_element.call(null,val_18115));
...
var ctx = ({});
var vec__18117 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__18117,(0),null);
var derefed = cljs.core.nth.call(null,vec__18117,(1),null);
...
var G__18120 = (cljs.core.count.call(null,argv) - first_child);
switch (G__18120) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__18120){
