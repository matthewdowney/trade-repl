...
var G__19612 = o;
(G__19612[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__19614__i = 0, G__19614__a = new Array(arguments.length -  0);
while (G__19614__i < G__19614__a.length) {G__19614__a[G__19614__i] = arguments[G__19614__i + 0]; ++G__19614__i;}
  args = new cljs.core.IndexedSeq(G__19614__a,0,null);
} 
return G__19613__delegate.call(this,args);};
G__19613.cljs$lang$maxFixedArity = 0;
G__19613.cljs$lang$applyTo = (function (arglist__19615){
...
var G__19616 = o;
(G__19616[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__19621 = props;
var G__19621__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__19621,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__19621);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__19621__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__19622){
...
var props = map__19623__$1;
var class$ = cljs.core.get.call(null,map__19623__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__19623,map__19623__$1,props,class$){
return (function (c){
...
});})(map__19623,map__19623__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__19625){
...
var on_write = cljs.core.get.call(null,map__19626__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__19626,map__19626__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__19626,map__19626__$1,on_write))
);
} else {
...
var G__19629 = jsprops;
(G__19629["defaultValue"] = value);

(G__19629["onChange"] = ((function (G__19629,v,value,on_change){
return (function (p1__19628_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__19628_SHARP_);
});})(G__19629,v,value,on_change))
);
...
var vec__19632 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__19632,(0),null);
var id = cljs.core.nth.call(null,vec__19632,(1),null);
var class$ = cljs.core.nth.call(null,vec__19632,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___19636 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___19636 == null)){
} else {
var key_19637 = temp__5461__auto___19636;
(jsprops["key"] = key_19637);
}
...
var temp__5461__auto___19638 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___19638 == null)){
} else {
var key_19639 = temp__5461__auto___19638;
reagent.impl.template.oset.call(null,jsprops,"key",key_19639);
}
...
var G__19640 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__19640["name"] = c);
...
var len__4499__auto___19645 = arguments.length;
var i__4500__auto___19646 = (0);
while(true){
if((i__4500__auto___19646 < len__4499__auto___19645)){
args__4502__auto__.push((arguments[i__4500__auto___19646]));

var G__19647 = (i__4500__auto___19646 + (1));
i__4500__auto___19646 = G__19647;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq19643){
var G__19644 = cljs.core.first.call(null,seq19643);
var seq19643__$1 = cljs.core.next.call(null,seq19643);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19644,seq19643__$1);
});
...
break;
default:
var G__19650 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__19650;
continue;
...
var n__4376__auto___19652 = a.length;
var i_19653 = (0);
while(true){
if((i_19653 < n__4376__auto___19652)){
(a[i_19653] = reagent.impl.template.as_element.call(null,(a[i_19653])));

var G__19654 = (i_19653 + (1));
i_19653 = G__19654;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___19655 = a.length;
var i_19656 = (0);
while(true){
if((i_19656 < n__4376__auto___19655)){
var val_19657 = (a[i_19656]);
if(((cljs.core.vector_QMARK_.call(null,val_19657)) && ((reagent.impl.template.key_from_vec.call(null,val_19657) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_19656] = reagent.impl.template.as_element.call(null,val_19657));

var G__19658 = (i_19656 + (1));
i_19656 = G__19658;
continue;
} else {
}
...
var ctx = ({});
var vec__19659 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__19659,(0),null);
var derefed = cljs.core.nth.call(null,vec__19659,(1),null);
...
var G__19662 = (cljs.core.count.call(null,argv) - first_child);
switch (G__19662) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__19662){
