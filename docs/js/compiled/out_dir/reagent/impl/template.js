...
var G__14902 = o;
(G__14902[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__14904__i < G__14904__a.length) {G__14904__a[G__14904__i] = arguments[G__14904__i + 0]; ++G__14904__i;}
  args = new cljs.core.IndexedSeq(G__14904__a,0,null);
} 
...
var G__14906 = o;
(G__14906[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__14911 = props;
var G__14911__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__14911,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__14911);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__14911__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__14912){
...
var props = map__14913__$1;
var class$ = cljs.core.get.call(null,map__14913__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__14913,map__14913__$1,props,class$){
return (function (c){
...
});})(map__14913,map__14913__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__14915){
...
var on_write = cljs.core.get.call(null,map__14916__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__14916,map__14916__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__14916,map__14916__$1,on_write))
);
} else {
...
var G__14919 = jsprops;
(G__14919["defaultValue"] = value);

(G__14919["onChange"] = ((function (G__14919,v,value,on_change){
return (function (p1__14918_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__14918_SHARP_);
});})(G__14919,v,value,on_change))
);
...
var vec__14922 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__14922,(0),null);
var id = cljs.core.nth.call(null,vec__14922,(1),null);
var class$ = cljs.core.nth.call(null,vec__14922,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___14926 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___14926 == null)){
} else {
var key_14927 = temp__5461__auto___14926;
(jsprops["key"] = key_14927);
}
...
var temp__5461__auto___14928 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___14928 == null)){
} else {
var key_14929 = temp__5461__auto___14928;
reagent.impl.template.oset.call(null,jsprops,"key",key_14929);
}
...
var G__14930 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__14930["name"] = c);
...
var len__4499__auto___14935 = arguments.length;
var i__4500__auto___14936 = (0);
while(true){
if((i__4500__auto___14936 < len__4499__auto___14935)){
args__4502__auto__.push((arguments[i__4500__auto___14936]));

var G__14937 = (i__4500__auto___14936 + (1));
i__4500__auto___14936 = G__14937;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14933){
...
break;
default:
var G__14940 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__14940;
continue;
...
var n__4376__auto___14942 = a.length;
var i_14943 = (0);
while(true){
if((i_14943 < n__4376__auto___14942)){
(a[i_14943] = reagent.impl.template.as_element.call(null,(a[i_14943])));

var G__14944 = (i_14943 + (1));
i_14943 = G__14944;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___14945 = a.length;
var i_14946 = (0);
while(true){
if((i_14946 < n__4376__auto___14945)){
var val_14947 = (a[i_14946]);
if(((cljs.core.vector_QMARK_.call(null,val_14947)) && ((reagent.impl.template.key_from_vec.call(null,val_14947) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_14946] = reagent.impl.template.as_element.call(null,val_14947));

var G__14948 = (i_14946 + (1));
i_14946 = G__14948;
continue;
} else {
}
...
var ctx = ({});
var vec__14949 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__14949,(0),null);
var derefed = cljs.core.nth.call(null,vec__14949,(1),null);
...
var G__14952 = (cljs.core.count.call(null,argv) - first_child);
switch (G__14952) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__14952){
