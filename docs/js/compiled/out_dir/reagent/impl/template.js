...
var G__30939 = o;
(G__30939[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__30941__i < G__30941__a.length) {G__30941__a[G__30941__i] = arguments[G__30941__i + 0]; ++G__30941__i;}
  args = new cljs.core.IndexedSeq(G__30941__a,0,null);
} 
...
var args = cljs.core.seq(arglist__30942);
...
var G__30943 = o;
(G__30943[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__30948 = props;
var G__30948__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__30948,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__30948);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__30948__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__30949){
...
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__30950,map__30950__$1,props,class$){
return (function (c){
...
});})(map__30950,map__30950__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__30952){
var map__30953 = p__30952;
var map__30953__$1 = ((((!((map__30953 == null)))?(((((map__30953.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__30953.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__30953):map__30953);
var on_write = cljs.core.get.call(null,map__30953__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__30953,map__30953__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__30953,map__30953__$1,on_write))
);
} else {
...
var G__30956 = jsprops;
(G__30956["defaultValue"] = value);

(G__30956["onChange"] = ((function (G__30956,v,value,on_change){
return (function (p1__30955_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__30955_SHARP_);
});})(G__30956,v,value,on_change))
);
...
var vec__30959 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__30959,(0),null);
var id = cljs.core.nth.call(null,vec__30959,(1),null);
var class$ = cljs.core.nth.call(null,vec__30959,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___30963 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___30963 == null)){
} else {
var key_30964 = temp__5461__auto___30963;
(jsprops["key"] = key_30964);
}
...
var temp__5461__auto___30965 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___30965 == null)){
} else {
var key_30966 = temp__5461__auto___30965;
reagent.impl.template.oset.call(null,jsprops,"key",key_30966);
}
...
var G__30967 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__30967["name"] = c);
...
var len__4499__auto___30972 = arguments.length;
var i__4500__auto___30973 = (0);
while(true){
if((i__4500__auto___30973 < len__4499__auto___30972)){
args__4502__auto__.push((arguments[i__4500__auto___30973]));

var G__30974 = (i__4500__auto___30973 + (1));
i__4500__auto___30973 = G__30974;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq30970){
var G__30971 = cljs.core.first.call(null,seq30970);
var seq30970__$1 = cljs.core.next.call(null,seq30970);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30971,seq30970__$1);
});
...
break;
default:
var G__30977 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__30977;
continue;
...
var n__4376__auto___30979 = a.length;
var i_30980 = (0);
while(true){
if((i_30980 < n__4376__auto___30979)){
(a[i_30980] = reagent.impl.template.as_element.call(null,(a[i_30980])));

var G__30981 = (i_30980 + (1));
i_30980 = G__30981;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___30982 = a.length;
var i_30983 = (0);
while(true){
if((i_30983 < n__4376__auto___30982)){
var val_30984 = (a[i_30983]);
if(((cljs.core.vector_QMARK_.call(null,val_30984)) && ((reagent.impl.template.key_from_vec.call(null,val_30984) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_30983] = reagent.impl.template.as_element.call(null,val_30984));

var G__30985 = (i_30983 + (1));
i_30983 = G__30985;
continue;
} else {
}
...
var ctx = ({});
var vec__30986 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__30986,(0),null);
var derefed = cljs.core.nth.call(null,vec__30986,(1),null);
...
var G__30989 = (cljs.core.count.call(null,argv) - first_child);
switch (G__30989) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__30989){
