...
if((i < len)){
var k = (ks[i]);
var G__14845 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__14846 = (i + (1));
m = G__14845;
i = G__14846;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__14848 = c;
var G__14848__$1 = (((G__14848 == null))?null:G__14848.prototype);
if((G__14848__$1 == null)){
return null;
} else {
return (G__14848__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__14850 = c;
var G__14850__$1 = (((G__14850 == null))?null:G__14850.prototype);
if((G__14850__$1 == null)){
return null;
} else {
return (G__14850__$1["render"]);
}
})() == null))));
});
...
while (G__14854__i < G__14854__a.length) {G__14854__a[G__14854__i] = arguments[G__14854__i + 0]; ++G__14854__i;}
  args = new cljs.core.IndexedSeq(G__14854__a,0,null);
} 
return G__14853__delegate.call(this,args);};
G__14853.cljs$lang$maxFixedArity = 0;
G__14853.cljs$lang$applyTo = (function (arglist__14855){
var args = cljs.core.seq(arglist__14855);
return G__14853__delegate(args);
});
...
var _STAR_current_component_STAR_14857 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_14857;
}});
...
return ((function (G__14858,G__14858__$1){
...
var c = this;
var G__14863_14865 = (c["cljsRatom"]);
if((G__14863_14865 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__14863_14865);
}
...
var renders_14867 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_14868 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_14867));
if((cljs.core.count.call(null,renders_14867) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_14867))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_14868)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_14868))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__14866 = name;
switch (G__14866) {
case "":
...
var G__14870 = o;
(G__14870[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__14871 = fiber;
var G__14871__$1 = (((G__14871 == null))?null:(G__14871["type"]));
if((G__14871__$1 == null)){
return null;
} else {
return (G__14871__$1["displayName"]);
}
})();
var parent = (function (){var G__14872 = fiber;
if((G__14872 == null)){
return null;
} else {
return (G__14872["return"]);
}
})();
var path = (function (){var G__14873 = parent;
var G__14873__$1 = (((G__14873 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__14873));
if((G__14873__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14873__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__14875 = c;
if((G__14875 == null)){
return null;
} else {
return (G__14875["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__14876._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__14878 = c;
if((G__14878 == null)){
return null;
} else {
return (G__14878["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__14880 = c;
if((G__14880 == null)){
return null;
} else {
return G__14880._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__14882 = instance;
if((G__14882 == null)){
return null;
} else {
return (G__14882["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__14883 = instance;
if((G__14883 == null)){
return null;
} else {
return G__14883._currentElement;
}
}
})();
var name = (function (){var G__14884 = elem;
var G__14884__$1 = (((G__14884 == null))?null:(G__14884["type"]));
if((G__14884__$1 == null)){
return null;
} else {
return (G__14884__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__14886 = elem;
if((G__14886 == null)){
return null;
} else {
return (G__14886["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__14887._owner;
}
}
})();
var path = (function (){var G__14888 = owner;
var G__14888__$1 = (((G__14888 == null))?null:reagent.impl.component.component_path.call(null,G__14888));
if((G__14888__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14888__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__14889 = c;
var G__14889__$1 = (((G__14889 == null))?null:G__14889.constructor);
if((G__14889__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__14889__$1);
}
}
})();
