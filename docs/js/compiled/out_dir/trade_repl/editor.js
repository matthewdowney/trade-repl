 ...
 */
trade_repl.editor.code_mirror = (function trade_repl$editor$code_mirror(contents_atom,key_map_atom,p__26827){
...
var style = cljs.core.get.call(null,map__26828__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var js_cm_opts = cljs.core.get.call(null,map__26828__$1,new cljs.core.Keyword(null,"js-cm-opts","js-cm-opts",1231776640));
var on_cm_init = cljs.core.get.call(null,map__26828__$1,new cljs.core.Keyword(null,"on-cm-init","on-cm-init",105207782));
var on_change = cljs.core.get.call(null,map__26828__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var instance_atom = cljs.core.atom.call(null,null);
return reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (instance_atom,map__26828,map__26828__$1,style,js_cm_opts,on_cm_init,on_change){
...
inst.on("change",((function (el,inst,instance_atom,map__26828,map__26828__$1,style,js_cm_opts,on_cm_init,on_change){
return (function (){
...
});})(el,inst,instance_atom,map__26828,map__26828__$1,style,js_cm_opts,on_cm_init,on_change))
);
...
});})(instance_atom,map__26828,map__26828__$1,style,js_cm_opts,on_cm_init,on_change))
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (instance_atom,map__26828,map__26828__$1,style,js_cm_opts,on_cm_init,on_change){
...
,new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (instance_atom,map__26828,map__26828__$1,style,js_cm_opts,on_cm_init,on_change){
return (function (_,___$1,___$2){
var G__26830_26831 = cljs.core.deref.call(null,instance_atom);
if((G__26830_26831 == null)){
} else {
G__26830_26831.setOption("vimMode",cljs.core._EQ_.call(null,"vim",cljs.core.deref.call(null,key_map_atom)));
}
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"button",new cljs.core.Keyword(null,"style","style",-496642736),(function (){var G__26832 = link_style;
if(cljs.core._EQ_.call(null,"vim",cljs.core.deref.call(null,key_map))){
return cljs.core.assoc.call(null,G__26832,new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),"bold");
} else {
return G__26832;
}
...
], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"button",new cljs.core.Keyword(null,"style","style",-496642736),(function (){var G__26833 = link_style;
if(cljs.core.not_EQ_.call(null,"vim",cljs.core.deref.call(null,key_map))){
return cljs.core.assoc.call(null,G__26833,new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),"bold");
} else {
return G__26833;
}
